          ...
          <div class="col-lg-4 col-md-12">
            <div class="card canasta-card">
              ...
              <div class="card-body">
                ...
                <button class="btn btn-primary mt-3" data-bs-toggle="offcanvas" href="#offcanvasRight" role="button" aria-controls="offcanvasRight" @click="prepareConfirmation" :disabled="isCartEmpty">Confirmar Producto</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="movements">
          ...
          <div class="transaction-section" v-if="currentSection === 'transacciones'">
            <div>
              ...
              <input type="text" v-model="ventaNombre"/>
              <label for="text">Fecha de la venta</label>
              <input type="date" v-model="ventaFecha"/>
            </div>
            <div class="transaction-table">
              ...
              <div>
                ...
                <input type="text" v-model="clienteNombre">
              </div>
              <div>
